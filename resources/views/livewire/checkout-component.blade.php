            ...
            <form wire:submit.prevent="placeOrder">
                        ...
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                ...
                                <p class="row-in-form">
                                    ...
                                    @error('zipcopde') <span class="text-danger">{{$message}}</span>@enderror
                                </p>
                                <p class="row-in-form">
                                    <label for="province">Province<span>*</span></label>
                                    <input type="text" name="province" value="" placeholder="Province" wire:model="province">
                                    @error('prodvince') <span class="text-danger">{{$message}}</span>@enderror
                                </p>
                                <p class="row-in-form">
                ...
                <div class="summary summary-checkout">
                    <div class="summary-item payment-method">
                        ...
                        @if ($payment_method == 'card')
                            <div class="wrap-address-billing">
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input type="text" name="expiry-year" value="" placeholder="YYYY" wire:model="expiry_year">
                        ...
                        @endif
                        <button type="submit" class="btn btn-medium">Place your order now!</button>
                    </div>
